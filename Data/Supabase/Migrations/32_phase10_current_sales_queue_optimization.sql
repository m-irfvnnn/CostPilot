-- ============================================
-- CostPilot Phase 10 — Current sales queue optimization
-- ============================================
-- Keeps the queue contract intact while removing the dependency on the heavier
-- sales_routing_signal_assembly view for operational queue reads.
